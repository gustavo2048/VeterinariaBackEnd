...
-- TABLA MASCOTA
INSERT INTO `mascota`(`borrado`, `caracteristicas`, `edad`, `foto`, `nombre`, `raza`, `tamaño`) 
VALUES (false, 'caracteristica1 gris', '12años', 'foto1.jpg', 'tito', 'razaDogo', 'Tamaño grande' );
INSERT INTO `mascota`(`borrado`, `caracteristicas`, `edad`, `foto`, `nombre`, `raza`, `tamaño`) 
VALUES (false, 'caracteristica2 gris', '1años', 'foto2.jpg', 'Rocco', 'pepe', 'Tamaño chico' );
INSERT INTO `mascota`(`borrado`, `caracteristicas`, `edad`, `foto`, `nombre`, `raza`, `tamaño`) 
VALUES (false, 'caracteristica3 gris', '2años', 'foto3.jpg', 'Toto', 'Labrador', 'Tamaño mediano' );
INSERT INTO `mascota`(`borrado`, `caracteristicas`, `edad`, `foto`, `nombre`, `raza`, `tamaño`) 
VALUES (false, 'caracteristica4 gris', '3años', 'foto4.jpg', 'Rocco2', 'Lazy', 'Tamaño mediano');
INSERT INTO `mascota`(`borrado`, `caracteristicas`, `edad`, `foto`, `nombre`, `raza`, `tamaño`) 
VALUES (false, 'caracteristica5 gris', '10años', 'foto5.jpg', 'Rocco3', 'Doberman', 'Tamaño mediano');
INSERT INTO `mascota`(`borrado`, `caracteristicas`, `edad`, `foto`, `nombre`, `raza`, `tamaño`) 
VALUES (false, 'caracteristica6 gris', '1años', 'foto6.jpg', 'Rocco4', 'Pitbull', 'Tamaño mediano');